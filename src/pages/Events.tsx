        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex flex-1 flex-col justify-between p-6">
            <div>
              ...
              {event.description && (
                <div className="mt-1 text-muted-foreground prose prose-sm prose-neutral dark:prose-invert max-w-none prose-p:my-1 prose-p:whitespace-pre-wrap [&_p:empty]:min-h-[1em] [&_p:empty]:my-0" dangerouslySetInnerHTML={{ __html: event.description }} />
              )}
